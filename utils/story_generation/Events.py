...
INPUT_FILE_PATH = f"{SG_PATH}/filtered_stories_150_Glot.txt"
OUTPUT_FILE_PATH = f"{SG_PATH}/story_elements_Glot150.txt" 
...
"""
    ...
    try:
        with open(output_file, "a", encoding="utf-8") as outfile:
            #outfile.write(f"\n--- Narrative Event Types from llama.cpp CLI run on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} ---\n\n")
...
def process_batch(
    ...
    try:
        ...
        # # Debug print after extracting the raw generation
        # print("\n--- CLEANED RAW GENERATION (before final parsing) ---")
        # print(clean_output)
        # print("--- END CLEANED RAW GENERATION ---\n")
