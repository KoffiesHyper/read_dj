...
output_file1 = f'{SG_PATH}/filtered_stories_400_to_800_AFP.txt' # Output of Aesop for Children stories with fewer than 150 words
input_file2 = f'{SG_PATH}/Glot_cleaned_stories.txt' # Input of GlotStoryBook
output_file2 = f'{SG_PATH}/filtered_stories_400_to_800_Glot.txt' # Output of GlotStoryBook stories with fewer than 150 words
